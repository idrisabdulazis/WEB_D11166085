    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-light">
                <div style="background-color:lightblue" class="h5 text-center card-header ">{{ __('REGISTER') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                    <!-- memberikan warna-->
                    <div style="background-color:lightblue" class="card-header h5 text-center">
                        @csrf
